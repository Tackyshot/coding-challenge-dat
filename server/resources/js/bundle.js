...
//export an instance of flux for all stores / actions to use
var alt = new _lib2.default();
module.exports = alt;
...
var CustomersActions = function () {
  function CustomersActions() {
    _classCallCheck(this, CustomersActions);
  }

  _createClass(CustomersActions, [{
    key: 'load',
    value: function load(id) {
      return function (dispatch) {
        _superagent2.default.get('/api/v1/customer').type('application/json').accept('application/json').end(function (err, res) {
    ...
    key: 'insert',
    value: function insert(customer) {
      return function (dispatch) {
        _superagent2.default.post('/api/v1/customer').type('application/json').accept('application/json').send(customer).end(function (err, res) {
          if (!!err) return console.error(err);
...
exports.default = _alt2.default.createActions(CustomersActions);
...
var CustomerActions = function () {
  function CustomerActions() {
    _classCallCheck(this, CustomerActions);
  }

  _createClass(CustomerActions, [{
    key: 'load',
    value: function load(id) {
      return function (dispatch) {
        _superagent2.default.get('/api/v1/customer/' + id).type('application/json').accept('application/json').end(function (err, res) {
          if (!!err) return console.error(err);
    ...
    value: function update(id, customer) {
      return function (dispatch) {
        _superagent2.default.put('/api/v1/customer/' + id).type('application/json').accept('application/json').send(customer).end(function (err, res) {
          if (!!err) return console.error(err);
    ...
    value: function _delete(id) {
      return function (dispatch) {
        _superagent2.default.del('/api/v1/customer/' + id).type('application/json').accept('application/json').end(function (err, res) {
          if (!!err) return console.error(err);
    ...
    value: function updateFieldValue(key, value) {
      return function (dispatch) {
...
exports.default = _alt2.default.createActions(CustomerActions);
...
var _head = __webpack_require__(52);

var _head2 = _interopRequireDefault(_head);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_head2.default, null), document.getElementById("App"));
...
var _customers = __webpack_require__(80);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h1',
            null,
            'DAT Customer Management Tool'
          ),
          _react2.default.createElement(_reactRouterDom.Route, { path: '/', exact: true, render: function render(props) {
              return _react2.default.createElement(_customers2.default, props);
            } }),
          _react2.default.createElement(_reactRouterDom.Route, { path: '/customer/:customerId', exact: true, render: function render(props) {
              return _react2.default.createElement(_customer2.default, props);
            } })
        )
      );
    } //render
...
var _newCustomer = __webpack_require__(81);
...
var _customers3 = __webpack_require__(97);

var _customers4 = _interopRequireDefault(_customers3);
...
var Customers = function (_Component) {
  ...
  function Customers(props) {
    ...
    _this.state = {
      ...
      //rebindings
    };_this.handleCustomersChange = _this.handleCustomersChange.bind(_this);
    return _this;
  }
  ...
  _createClass(Customers, [{
    ...
    value: function componentWillMount() {
      _customers4.default.listen(this.handleCustomersChange);
      _customers2.default.load();
    } //componentWillMount
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_newCustomer2.default, this.props),
        _react2.default.createElement('hr', null),
        _react2.default.createElement(
          'h3',
          null,
    ...
    value: function componentWillUnmount() {
      _customers4.default.unlisten(this.handleCustomersChange);
    } //componentWillUnmount

  }, {
    key: 'handleCustomersChange',
    value: function handleCustomersChange(customersStore) {
...
var NewCustomer = function (_Component) {
  _inherits(NewCustomer, _Component);
  ...
  _createClass(NewCustomer, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          'First Name:',
          _react2.default.createElement('input', { type: 'text', name: 'firstName', defaultValue: customer.firstName, onChange: this.handleChange })
        ),
        _react2.default.createElement(
          'label',
          null,
          'Last Name:',
          _react2.default.createElement('input', { type: 'text', name: 'lastName', defaultValue: customer.lastName, onChange: this.handleChange })
        ),
        _react2.default.createElement(
          'label',
          null,
          'Street Address:',
          _react2.default.createElement('input', { type: 'text', name: 'streetAddress', defaultValue: customer.streetAddress, onChange: this.handleChange })
        ),
        _react2.default.createElement(
          'label',
          null,
          'Street Address 2:',
          _react2.default.createElement('input', { type: 'text', name: 'streetAddress2', defaultValue: customer.streetAddress2, onChange: this.handleChange })
        ),
        _react2.default.createElement(
          'label',
          null,
          'City:',
          _react2.default.createElement('input', { type: 'text', name: 'city', defaultValue: customer.city, onChange: this.handleChange })
        ),
        _react2.default.createElement(
          'label',
          null,
          'State:',
          _react2.default.createElement('input', { type: 'text', name: 'state', defaultValue: customer.state, onChange: this.handleChange })
        ),
        _react2.default.createElement(
          'label',
          null,
          'Zip-Code:',
          _react2.default.createElement('input', { type: 'text', name: 'zip', defaultValue: customer.zip, onChange: this.handleChange })
        ),
        _react2.default.createElement(
          'button',
          {
            onClick: function onClick() {
              return _customers2.default.insert(_this2.state.customer);
            },
    ...
    value: function handleChange(e) {
      var nState = _extends({}, this.state);
...
var _StateFunctions = __webpack_require__(86);
...
var _AltStore = __webpack_require__(88);

var _AltStore2 = _interopRequireDefault(_AltStore);

var _StoreMixin = __webpack_require__(89);
...
var _transmitter = __webpack_require__(32);
...
var _isPromise = __webpack_require__(91);
...
var CustomersStore = function () {
  function CustomersStore() {
    _classCallCheck(this, CustomersStore);

    this.bindActions(_customers2.default);
  ...
  _createClass(CustomersStore, [{
    key: 'onLoad',
    value: function onLoad(customers) {
      this.setState({ customers: customers });
    } //onLoad

  }, {
    key: 'onInsert',
    value: function onInsert(customer) {
      var nState = _extends({}, this.state);
...
exports.default = _alt2.default.createStore(CustomersStore);
...
var _customer = __webpack_require__(35);

var _customer2 = _interopRequireDefault(_customer);

var _customer3 = __webpack_require__(99);
...
var Customer = function (_Component) {
  ...
  _createClass(Customer, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      _customer4.default.listen(this.handleStoreChange);
      _customer2.default.load(this.props.match.params.customerId);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', {
            ...
            onChange: function onChange(e) {
              return _customer2.default.updateFieldValue(e.target.name, e.target.value);
            } })
        ),
        _react2.default.createElement(
          'label',
        ...
        _react2.default.createElement(
          ...
          {
            onClick: function onClick() {
              return _customer2.default.update(_this2.state.id, _this2.state.customer);
            },
            style: { width: '150px', padding: '10px', margin: '10px', color: 'white', backgroundColor: '#306ca0', cursor: 'pointer' }
          },
          'Update Customer'
    ...
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _customer4.default.unlisten(this.handleStoreChange);
    } //componentWillUnmount

  }, {
    key: 'handleStoreChange',
    value: function handleStoreChange(customerStore) {
    ...
    value: function handleDeleteAction() {
      _customer2.default.delete(this.state.id);
...
var CustomerStore = function () {
  function CustomerStore() {
    ...
    this.bindActions(_customer2.default);
  ...
  _createClass(CustomerStore, [{
    key: 'onLoad',
    value: function onLoad(customer) {
      this.setState(customer);
    } //onLoad

  }, {
    key: 'onUpdate',
    value: function onUpdate(customer) {
      this.setState(customer);
    } //onUpdate
    ...
    key: 'onUpdateFieldValue',
    value: function onUpdateFieldValue(kvPair) {
      var nState = _extends({}, this.state);
...
exports.default = _alt2.default.createStore(CustomerStore);
